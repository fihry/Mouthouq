...
# API Documentation
## System Architecture
See detailed architecture diagram in [API Architecture](./diagrams/API_ARCHITECTURE.md)

## Database Schema
See detailed database schema in [Database Schema](./diagrams/DB_SCHEMA.md)
## Authentication
